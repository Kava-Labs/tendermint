...
// source: rpc/grpc/types_suffix_two.proto
...
func (*RequestPing) Descriptor() ([]byte, []int) {
	return fileDescriptor_17feb2175ba40b8c, []int{0}
}
...
func (*RequestBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_17feb2175ba40b8c, []int{1}
}
...
func (*ResponsePing) Descriptor() ([]byte, []int) {
	return fileDescriptor_17feb2175ba40b8c, []int{2}
}
...
func (*ResponseBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_17feb2175ba40b8c, []int{3}
}
...
func init() { proto.RegisterFile("rpc/grpc/types_suffix_two.proto", fileDescriptor_17feb2175ba40b8c) }
func init() {
	golang_proto.RegisterFile("rpc/grpc/types_suffix_two.proto", fileDescriptor_17feb2175ba40b8c)
}

var fileDescriptor_17feb2175ba40b8c = []byte{
	// 366 bytes of a gzipped FileDescriptorProto
	,
}
...
var _BroadcastAPI_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "rpc/grpc/types_suffix_two.proto",
}
...
func (m *RequestBroadcastTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Tx) > 0 {
		i -= len(m.Tx)
		copy(dAtA[i:], m.Tx)
		i = encodeVarintTypesSuffixTwo(dAtA, i, uint64(len(m.Tx)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
	...
	if m.DeliverTx != nil {
		{
			...
			i -= size
			i = encodeVarintTypesSuffixTwo(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x12
	}
...
func encodeVarintTypesSuffixTwo(dAtA []byte, offset int, v uint64) int {
	offset -= sovTypesSuffixTwo(v)
	base := offset
	for v >= 1<<7 {
...
func NewPopulatedRequestPing(r randyTypesSuffixTwo, easy bool) *RequestPing {
	this := &RequestPing{}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypesSuffixTwo(r, 1)
	}
	return this
}

func NewPopulatedRequestBroadcastTx(r randyTypesSuffixTwo, easy bool) *RequestBroadcastTx {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypesSuffixTwo(r, 2)
	}
	return this
}

func NewPopulatedResponsePing(r randyTypesSuffixTwo, easy bool) *ResponsePing {
	this := &ResponsePing{}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypesSuffixTwo(r, 1)
	}
...
func NewPopulatedResponseBroadcastTx(r randyTypesSuffixTwo, easy bool) *ResponseBroadcastTx {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypesSuffixTwo(r, 3)
	}
	return this
}

type randyTypesSuffixTwo interface {
	Float32() float32
	Float64() float64
	Int63() int64
	Int31() int32
...
func randUTF8RuneTypesSuffixTwo(r randyTypesSuffixTwo) rune {
	ru := r.Intn(62)
	if ru < 10 {
		return rune(ru + 48)
	} else if ru < 36 {
...
func randStringTypesSuffixTwo(r randyTypesSuffixTwo) string {
	v2 := r.Intn(100)
	tmps := make([]rune, v2)
	for i := 0; i < v2; i++ {
		tmps[i] = randUTF8RuneTypesSuffixTwo(r)
	}
	return string(tmps)
}
func randUnrecognizedTypesSuffixTwo(r randyTypesSuffixTwo, maxFieldNumber int) (dAtA []byte) {
	l := r.Intn(5)
	for i := 0; i < l; i++ {
		wire := r.Intn(4)
		if wire == 3 {
		...
		dAtA = randFieldTypesSuffixTwo(dAtA, r, fieldNumber, wire)
	}
	return dAtA
}
func randFieldTypesSuffixTwo(dAtA []byte, r randyTypesSuffixTwo, fieldNumber int, wire int) []byte {
	key := uint32(fieldNumber)<<3 | uint32(wire)
	switch wire {
	case 0:
		dAtA = encodeVarintPopulateTypesSuffixTwo(dAtA, uint64(key))
		v3 := r.Int63()
		if r.Intn(2) == 0 {
			v3 *= -1
		}
		dAtA = encodeVarintPopulateTypesSuffixTwo(dAtA, uint64(v3))
	case 1:
		dAtA = encodeVarintPopulateTypesSuffixTwo(dAtA, uint64(key))
	...
	case 2:
		dAtA = encodeVarintPopulateTypesSuffixTwo(dAtA, uint64(key))
		ll := r.Intn(100)
		dAtA = encodeVarintPopulateTypesSuffixTwo(dAtA, uint64(ll))
		for j := 0; j < ll; j++ {
...
func encodeVarintPopulateTypesSuffixTwo(dAtA []byte, v uint64) []byte {
	for v >= 1<<7 {
...
func (m *RequestBroadcastTx) Size() (n int) {
	...
	l = len(m.Tx)
	if l > 0 {
		n += 1 + l + sovTypesSuffixTwo(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func sovTypesSuffixTwo(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozTypesSuffixTwo(x uint64) (n int) {
	return sovTypesSuffixTwo(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *RequestPing) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowTypesSuffixTwo
			}
			if iNdEx >= l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipTypesSuffixTwo(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
				return ErrInvalidLengthTypesSuffixTwo
			}
			if (iNdEx + skippy) < 0 {
				return ErrInvalidLengthTypesSuffixTwo
			}
...
func skipTypesSuffixTwo(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowTypesSuffixTwo
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthTypesSuffixTwo
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupTypesSuffixTwo
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthTypesSuffixTwo        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowTypesSuffixTwo          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupTypesSuffixTwo = fmt.Errorf("proto: unexpected end of group")
)
