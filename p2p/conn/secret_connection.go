...
import (
	...
	"github.com/kava-labs/tendermint/libs/async"
)
...
// See https://github.com/kava-labs/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/kava-labs/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/kava-labs/tendermint/issues/3531
