...
script](https://github.com/kava-labs/tendermint/blob/master/networks/remote/integration.sh)
...
directory](https://github.com/kava-labs/tendermint/tree/master/networks/remote/ansible)
