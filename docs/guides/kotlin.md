...
file](https://github.com/kava-labs/tendermint/blob/master/abci/types/types.proto).
...
```sh
mkdir -p \
  $KVSTORE_HOME/src/main/proto/github.com/kava-labs/tendermint/abci/types \
  $KVSTORE_HOME/src/main/proto/github.com/kava-labs/tendermint/crypto/merkle \
  $KVSTORE_HOME/src/main/proto/github.com/kava-labs/tendermint/libs/kv \
  $KVSTORE_HOME/src/main/proto/github.com/gogo/protobuf/gogoproto

cp $GOPATH/src/github.com/kava-labs/tendermint/abci/types/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/kava-labs/tendermint/abci/types/types.proto
cp $GOPATH/src/github.com/kava-labs/tendermint/crypto/merkle/merkle.proto \
   $KVSTORE_HOME/src/main/proto/github.com/kava-labs/tendermint/crypto/merkle/merkle.proto
cp $GOPATH/src/github.com/kava-labs/tendermint/libs/kv/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/kava-labs/tendermint/libs/kv/types.proto
...
package](https://godoc.org/github.com/kava-labs/tendermint/lite)) can leverage
...
```sh
$ rm -rf /tmp/example
$ cd $GOPATH/src/github.com/kava-labs/tendermint
$ make install
...
Github](https://github.com/kava-labs/tendermint/issues/new/choose). To dig
