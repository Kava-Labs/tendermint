...
(ABCI)](https://github.com/kava-labs/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/kava-labs/tendermint) (the
...
Types](https://github.com/kava-labs/tendermint/blob/master/abci/README.md#message-types).
